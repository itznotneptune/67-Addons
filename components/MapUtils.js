...
export let roomsJson = JSON.parse(FileLib.read("67-Addons", "components/rooms.json"))
...
request({url: "https://raw.githubusercontent.com/UnclaimedBloom6/IllegalMap/main/IllegalMap/utils/rooms.json", json: true}).then(data => {
    ...
    FileLib.write("67-Addons", "components/rooms.json", JSON.stringify(roomsJson, null, 4))
})
...
export const questionMarkVanilla = new Image("questionMarkVanilla.png", "../../assets/questionMarkVanilla.png")
