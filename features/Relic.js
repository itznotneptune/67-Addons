...
// Archer
register("chat", () => {
    if (config.Relic || getClass() !== "Archer") return;
    ChatLib.command("pc Archer --> Red Relic");
}).setCriteria("[BOSS] Necron: All this, for nothing...");

// Berserk
register("chat", () => {
    if (config.Relic || getClass() !== "Berserk") return;
    ChatLib.command("pc Bers --> Orange Relic");
}).setCriteria("[BOSS] Necron: All this, for nothing...");

// Healer
register("chat", () => {
    if (config.Relic || getClass() !== "Healer") return;
    ChatLib.command("pc Healer --> Purple Relic");
}).setCriteria("[BOSS] Necron: All this, for nothing...");

// Mage
register("chat", () => {
    if (config.Relic || getClass() !== "Mage") return;
    ChatLib.command("pc Mage --> Blue Relic");
}).setCriteria("[BOSS] Necron: All this, for nothing...");

// Tank
register("chat", () => {
    if (config.Relic || getClass() !== "Tank") return;
...
//     else if (config.Relic || getClass() === "Healer") return;
//     ChatLib.command("pc" + getClass() + " --> Purple Relic");
//     else if (config.Relic || getClass() === "Mage") return;
//     ChatLib.command("pc" + getClass() + " --> Blue Relic");
//     else if (config.Relic || getClass() === "Berserk") return;
//     ChatLib.command("pc" + getClass() + " --> Orange Relic");
//     else if (config.Relic || getClass() === "Archer") return;
