...
import { getItemApiData, getSellPrice, getSkyblockItems } from "./dungoenChest"
...
export const acPogObj = new PogObject("67-Addons", {
    lastApiUpdate: null,
...
}, "features/dungeonChest/data/data.json")
